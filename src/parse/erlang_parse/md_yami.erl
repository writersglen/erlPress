...
%%% @copyright  2018 Lloyd R. Prentice <lloyd@writersglen.com>
%%% @version   .01
%%% @doc
%%%   License:      MIT
%%%   File:         md_yami.erl 
%%%   Description:  Work-in-progres toward Erlang implementation of 
%%%                 CommonMark spec http://spec.commonmark.org/0.27/
%%% 
%%%                 Many suble edge cases, so can't guarantee I've 
%%%                 caught them all. Thanks to Richard O'Keefe for 
%%%                 insiration and tips.
%%% @end
